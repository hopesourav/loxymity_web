    ...
    <div className="min-h-screen bg-dark-bg">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-dark-bg/85 backdrop-blur-lg border-b border-dark-border">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-7 text-sm font-medium text-dark-muted">
      ...
      <section className="relative pt-32 pb-0 px-6 text-center bg-dark-bg overflow-hidden">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(ellipse 80% 55% at 50% -5%, rgba(92,107,248,0.32), transparent 70%)' }}
        />
        {/* Dot grid texture */}
        <div
        ...
        <div className="relative max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-dark-surface border border-dark-border text-primary text-sm font-semibold px-4 py-1.5 rounded-full mb-6">
            <span className="w-2 h-2 bg-primary rounded-full animate-pulse" />
            Live location sharing
          </div>
          <h1 className="text-5xl md:text-[4.25rem] font-black tracking-tight text-dark-text leading-[1.08] mb-6">
            See where your<br />
        ...
        <div className="relative mt-16 max-w-[285px] mx-auto animate-float" style={{ willChange: 'transform' }}>
          ...
          {/* Chassis */}
          <div className="relative bg-dark-surface rounded-[3rem] p-[3px] ring-1 ring-dark-border shadow-2xl" style={{ boxShadow: '0 32px 80px rgba(92,107,248,0.18)' }}>
            <div className="bg-[#070d19] rounded-[2.8rem] overflow-hidden">
              ...
              <div className="px-4 pb-2 flex items-center justify-between">
                ...
                <div className="flex -space-x-2">
                  {[['S','#5C6BF8'],['A','#10B981'],['R','#F59E0B'],['M','#EF4444']].map(([init, col]) => (
                    <div
                      key={init}
              ...
              {/* Map area */}
              <div className="h-[168px] relative overflow-hidden" style={{ backgroundColor: '#0d1117' }}>
                <div className="absolute inset-0" style={{
                  backgroundImage: 'linear-gradient(rgba(255,255,255,0.025) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,0.025) 1px,transparent 1px)',
                  backgroundSize: '22px 22px',
                }} />
                <div className="absolute top-[41%] left-0 right-0 h-[2px]" style={{ backgroundColor: '#171f2e' }} />
                <div className="absolute top-[68%] left-0 right-0 h-[2px]" style={{ backgroundColor: '#171f2e' }} />
                <div className="absolute left-[27%] top-0 bottom-0 w-[2px]" style={{ backgroundColor: '#171f2e' }} />
                <div className="absolute left-[63%] top-0 bottom-0 w-[2px]" style={{ backgroundColor: '#171f2e' }} />

                {/* Sourav — active / pulsing */}
                <div className="absolute" style={{ top: '28%', left: '34%' }}>
                  <div
                    className="absolute rounded-full"
                    style={{ width: 28, height: 28, top: -11, left: -11, backgroundColor: 'rgba(92,107,248,0.18)', animation: 'beacon-ring 2.4s ease-out infinite' }}
                  />
                  <div className="w-3.5 h-3.5 rounded-full border-2 border-white/25" style={{ backgroundColor: '#5C6BF8' }} />
                </div>
                {/* Ananya */}
                <div className="absolute w-3 h-3 rounded-full" style={{ top: '56%', left: '61%', backgroundColor: '#10B981' }} />
                {/* Rohan */}
                <div className="absolute w-3 h-3 rounded-full" style={{ top: '37%', left: '15%', backgroundColor: '#F59E0B' }} />

                {/* Place label */}
                <div
                  className="absolute text-[8px] text-dark-muted rounded-md px-1.5 py-0.5"
                  style={{ top: '17%', left: '37%', backgroundColor: 'rgba(30,41,59,0.88)', border: '1px solid rgba(51,65,85,0.6)' }}
                >
                  Home
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5 px-3 py-3">
                {[
                  { name: 'Sourav', place: 'Home',   time: 'Just now',  color: '#5C6BF8', bat: 82 },
                  { name: 'Ananya', place: 'Office', time: '3 min ago', color: '#10B981', bat: 61 },
                  { name: 'Rohan',  place: 'School', time: '7 min ago', color: '#F59E0B', bat: 34 },
                ].map((m) => {
                  const bc = m.bat > 50 ? '#10B981' : m.bat > 20 ? '#F59E0B' : '#EF4444';
                  const bb = m.bat > 50 ? 'rgba(16,185,129,0.12)' : m.bat > 20 ? 'rgba(245,158,11,0.12)' : 'rgba(239,68,68,0.12)';
                  return (
                    <div key={m.name} className="bg-dark-surface rounded-xl px-3 py-2 flex items-center gap-2.5">
                      ...
                      <p className="text-[9px] flex-shrink-0" style={{ color: '#475569' }}>{m.time}</p>
                    </div>
                  );
                })}
              </div>
              ...
              <div className="h-12 border-t border-dark-border flex items-center justify-around px-3 pb-1">
                ...
                {/* SOS */}
                <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(239,68,68,0.12)', border: '1px solid rgba(239,68,68,0.22)' }}>
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="#EF4444" strokeWidth="2.5">
        ...
        <div className="max-w-5xl mx-auto px-6 py-7 flex flex-wrap justify-center gap-x-10 gap-y-3">
          {[
            ...
            <div key={label} className="flex items-center gap-2 text-dark-muted text-sm font-medium">
              <svg className="w-4 h-4 text-primary flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
                <path d={path} />
              </svg>
              {label}
            </div>
      ...
      <section id="features" className="py-24 px-6 bg-dark-bg">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-dark-text mb-4">Everything your circle needs</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div key={f.title} className="bg-dark-surface border border-dark-border rounded-2xl p-7 hover:border-primary/40 hover:shadow-lg transition-all duration-200 group relative" style={{ '--tw-shadow': '0 8px 32px rgba(92,107,248,0.06)' } as React.CSSProperties}>
                {f.badge && (
                  <span className="absolute top-4 right-4 bg-brand-warning/10 text-brand-warning border border-brand-warning/20 text-[10px] font-bold px-2 py-0.5 rounded-full">
                    {f.badge}
                  </span>
                )}
                ...
                <h3 className="text-base font-bold text-dark-text mb-2 group-hover:text-primary transition-colors">{f.title}</h3>
      ...
      <section className="py-24 px-6 bg-dark-surface">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-16 items-center">
          <div className="flex-1">
            ...
            <h2 className="text-4xl font-black text-dark-text mb-6">Never lose what matters</h2>
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative w-64 h-64 flex items-center justify-center">
              <div className="absolute inset-0 rounded-full border border-primary/8 animate-beacon-ring" />
              <div className="absolute inset-8 rounded-full border border-primary/12 animate-beacon-ring" style={{ animationDelay: '1s' }} />
              <div className="absolute inset-16 rounded-full border border-primary/18 animate-beacon-ring" style={{ animationDelay: '2s' }} />
              <div className="absolute inset-20 bg-dark-bg border border-dark-border rounded-3xl flex items-center justify-center shadow-xl" style={{ boxShadow: '0 0 40px rgba(92,107,248,0.15)' }}>
                <svg className="w-9 h-9 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section id="safety" className="py-24 px-6 bg-dark-bg">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black text-dark-text mb-4">There when it counts most</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              {
                iconPath: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01',
                bg: 'bg-primary/6 border border-primary/18', iconBg: 'bg-primary/10', iconColor: 'text-primary', titleColor: 'text-primary',
                title: 'Activity feed',
      ...
      <section id="how-it-works" className="py-24 px-6 bg-dark-surface">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-dark-text mb-4">Up and running in minutes</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              <div key={s.step} className="text-center relative">
                <div className="w-14 h-14 border-2 border-primary/35 bg-primary/8 text-primary font-black text-lg rounded-2xl flex items-center justify-center mx-auto mb-5">
                  {s.step}
                </div>
      ...
      <section id="pricing" className="py-24 px-6 bg-dark-bg">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-dark-text mb-4">Simple, honest pricing</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-dark-surface rounded-3xl p-8 border border-dark-border">
              ...
              <a href="#download" className="block text-center bg-dark-border hover:bg-[#475569] text-dark-text font-semibold px-6 py-3 rounded-xl transition-colors">
                Get started free
              </a>
            </div>

            {/* Pro */}
            <div className="relative rounded-3xl p-8 overflow-hidden shadow-2xl" style={{ background: 'linear-gradient(135deg, #5C6BF8 0%, #4251E8 55%, #3141D8 100%)', boxShadow: '0 24px 64px rgba(92,107,248,0.35)' }}>
              ...
              <div className="absolute top-4 right-4 bg-white/15 border border-white/25 backdrop-blur-sm text-white text-[10px] font-bold px-2.5 py-1 rounded-full">
                Most Popular
              </div>
              ...
              <a href="#download" className="relative block text-center bg-white hover:bg-indigo-50 text-primary font-bold px-6 py-3 rounded-xl transition-colors">
                Upgrade to Pro
              </a>
            </div>
      ...
      <section id="privacy" className="py-24 px-6 bg-dark-surface">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1">
            <h2 className="text-4xl font-black text-dark-text mb-6">Privacy first, always</h2>
            <div className="flex flex-col gap-4">
              {[
                ...
                <div key={point} className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary/15 border border-primary/30 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative w-52 h-52 flex items-center justify-center">
              ...
              <div className="absolute inset-16 bg-primary/10 border border-primary/30 rounded-full flex items-center justify-center" style={{ boxShadow: '0 0 32px rgba(92,107,248,0.15)' }}>
      ...
      <section id="faq" className="py-24 px-6 bg-dark-bg">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-dark-text mb-4">Frequently asked questions</h2>
      ...
      {/* ── Download CTA ─────────────────────────────────────────────────── */}
      <section className="relative py-24 px-6 overflow-hidden text-center" style={{ background: 'linear-gradient(135deg, #5C6BF8 0%, #4251E8 55%, #3141D8 100%)' }}>
        ...
        <div className="relative max-w-2xl mx-auto">
          ...
          <h2 className="text-4xl font-black text-white mb-4">Ready to stay connected?</h2>
          <p className="text-indigo-200 text-lg mb-10">Free to download. No subscription required to get started.</p>
      ...
      <footer className="py-12 px-6 bg-dark-bg border-t border-dark-border">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-6 text-sm text-dark-muted">
            ...
            <a href="/admin"   className="transition-colors" style={{ color: '#1E293B' }}>Admin</a>
          </div>
        </div>
      </footer>
...
function CheckIcon({ white }: { white?: boolean }) {
  return (
    <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 ${white ? 'bg-white/20' : 'bg-primary/15 border border-primary/25'}`}>
